    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('text', 'Texto corto'), ('textarea', 'Texto largo'), (
                    'number', 'Número'), ('date', 'Fecha'), ('select', 'Selección'), ('file', 'Archivo')], max_length=20)),
                ...
                ('formulario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='campos', to='tipo_solicitudes.formulariosolicitud')),
            ],
        ),
        migrations.CreateModel(
            name='Solicitud',
            fields=[
                ...
                ('tipo_solicitud', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='tipo_solicitudes.tiposolicitud')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estatus', models.CharField(choices=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campo', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='tipo_solicitudes.campoformulario')),
                ('solicitud', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='respuestas', to='tipo_solicitudes.solicitud')),
            ],
        ),
        migrations.CreateModel(
            name='ArchivoAdjunto',
            fields=[
                ...
                ('archivo', models.FileField(
                    upload_to=tipo_solicitudes.models.upload_path)),
                ('nombre', models.CharField(blank=True, max_length=255)),
                ('respuesta', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                 related_name='archivos', to='tipo_solicitudes.respuestacampo')),
                ('solicitud', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='archivos', to='tipo_solicitudes.solicitud')),
            ],
        ),
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                                       related_name='formulario', to='tipo_solicitudes.tiposolicitud'),
        ),
    ]
